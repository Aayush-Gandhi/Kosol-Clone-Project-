          ...
          <div className='bg-black/[.90]'>
               <div className="flex px-[8%] lg:px-[8%] py-[5%] flex-col lg:flex-row">
                    ...
                    <div className='text-white text-justify lg:w-1/2 lg:pl-20'>
                         ...
                         <p className='text-baselg:text-4xl font-semibold text-white'>Kosol Energie Pvt Ltd.</p>
                         <p className='text-sm lg:text-lg font-normal mt-5 text-white/[.80]'>Kosol Energie Pvt. Ltd. (KOSOL) - an ISO 9001:2015, 14001:2015 & OHSAS 18001:2007 certified company is one of the largest manufacturers of eco-friendly.</p>
