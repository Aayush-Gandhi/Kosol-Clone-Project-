                         ...
                         solar.map((data) => {
                              return (
                                   <div className=''>
                                        ...
                                        <p className='lg:w-[80%] text-white mt-5 font-medium text-xs lg:text-xl'> {data.info} </p>
                                        <p className='mt-5 font-semibold text-[#00ACEF] pb-10 lg:pb-0'> <a href=""> Read More</a> </p>
                                   </div>
                              )
                         }
                         )
