        ...
        <div className='pt-20'>
            <div className='relative border m-5 '>
                <div className="absolute flex items-center gap-3 bg-[#00ACEF] -translate-y-8 translate-x-11 p-5">
                    ...
                    <p className='text-white text-sm lg:text-xl'>{date}</p>
                </div>
                <div className='p-10 mt-5'>
                    ...
                    <p className='text-lg lg:text-2xl text-white'>{info}</p>
                    <img src={img} className='mt-5 mb-5' alt="" />
                        <a href="#" onClick={() => navigate (`/Blog/BlogInner/${idpage}`)} className='text-[#00ACEF] text-lg lg:text-2xl font-semibold'> Read More </a>
                </div>
            </div>
        </div>
    )
